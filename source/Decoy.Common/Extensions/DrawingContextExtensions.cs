namespace Decoy.Common.Extensions
{
    ...
    public static class DrawingContextExtensions
    {
        public static void DrawRoundedRectangle(this DrawingContext dc, Brush brush, Pen pen, Rect rect, CornerRadius cornerRadius)
        {
            ...
            using (var context = geometry.Open())
            {
                ...
                context.ArcTo(
                    new Point(rect.TopLeft.X + cornerRadius.TopLeft, rect.TopLeft.Y),
                ...
                context.ArcTo(
                    new Point(rect.TopRight.X, rect.TopRight.Y + cornerRadius.TopRight),
                ...
                context.ArcTo(
                    new Point(rect.BottomRight.X - cornerRadius.BottomRight, rect.BottomRight.Y),
                ...
                context.ArcTo(
                    new Point(rect.BottomLeft.X, rect.BottomLeft.Y - cornerRadius.BottomLeft),
